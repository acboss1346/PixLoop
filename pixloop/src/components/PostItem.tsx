...
export const PostItem = ({ post }: Props) => {
  return (
    <div className="relative group">
      ...
      <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 blur-md opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none"></div>
